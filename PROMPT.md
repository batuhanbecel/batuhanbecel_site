...
You are an expert frontend architect and UI/UX designer. Your task is to design and scaffold a modern, minimal, yet creative personal portfolio website for a professional retoucher.
...
Use the following About Me text as the authoritative source for biography, timeline, and experience content. Do not rewrite unless explicitly requested.
...
Animations: Optional, subtle (Framer Motion allowed)
Deployment: Vercel
Domain: Personal custom domain
...
Floating vertical navigation bar on the left
...
Masonry grid
No filters
Lightbox with next/previous and keyboard navigation

Images must load automatically from:
/public/portfolio-images

7. SOCIAL MEDIA

Behance: https://www.behance.net/batuhanbecel
Instagram: https://www.instagram.com/batuhanbecel_/
LinkedIn: https://www.linkedin.com/in/batuhanbecel/
